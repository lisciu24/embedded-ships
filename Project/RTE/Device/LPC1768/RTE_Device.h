...
//     <i> VBUS drive signal (towards external charge pump or power management
//     unit).
...
//     <i> VBUS status input.
//     <i> When this function is not enabled via its corresponding PINSEL
...
// <i> Configuration settings for Driver_ETH_MAC0 in component
// ::Drivers:Ethernet MAC
#define RTE_ENET 0
